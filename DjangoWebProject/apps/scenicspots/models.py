...
class Spots(models.Model):
    ...
    x = models.DecimalField(decimal_places=6, max_digits=9, default=120.700000, verbose_name='经度')
    y = models.DecimalField(decimal_places=6, max_digits=9, default=28.000000, verbose_name='纬度')
